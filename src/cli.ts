...
program
  ...
  .argument(
    "<target>",
    "Community slug or Skool URL (e.g. ai-first-client-formula-8589)",
  )
  ...
  .action(async (target: string, opts) => {
    const parsed = parseSkoolUrl(target);
...
program
  ...
  .argument(
    "<target>",
    "Community slug or Skool URL (e.g. my-group — archives classroom; add --feed for wall)",
  )
  .option(
    "-o, --out <dir>",
